...
export const Message: FC<messageProp> = ({type, sender, time, text}) => {
  ...
  if (type === "self") {
    return (
      <div className="flex flex-row-reverse max-w-[70%] ml-auto mb-2 p-2 rounded-md shadow-md bg-indigo-900 bg-opacity-75 backdrop-blur-md border border-white/20 min-w-3xs">
    ...
    return (
      <div className="flex max-w-[70%] mr-auto mb-2 p-2 rounded-md shadow-md bg-indigo-100 bg-opacity-90 backdrop-blur-md border border-white/20 min-w-3xs">
