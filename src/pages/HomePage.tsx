  ...
  return (
    <>
      ...
      <footer className="p-1 bg-indigo-300 shadow-md sticky bottom-0 z-50">
        {user ? (
          <Input placeholder="Send me a message..." ref={inputRef} func={contactMe} btnText="Send" disabled={false}/>
        ) : (
          <Input placeholder="Welcome to Airchat!" ref={inputRef} func={() => navigate("/auth")} btnText="Get Started!" disabled={true} />
        )}
      </footer>
    </>
  );
